...
"$WASI_SDK/bin/clang++" --target=wasm32-wasip2 -fno-exceptions -O2 \
  ...
  -Wl,-z,stack-size=8388608 -Wl,--error-limit=0 -Wl,--export=cabi_realloc -Wl,--export=main -Wl,--export=__main_argc_argv \
