...
"$WASI_SDK/bin/clang++" --target=wasm32-wasip2 -fno-exceptions -O2 \
  ...
  $S/bunobj/*.o $OBJ/gen_*.o $OBJ/mod_*.o $OBJ/wasi_stubs.o $OBJ/imrc.o $OBJ/hdr_*.o $VLIB/libzstd.a $VLIB/libbrotli.a $VLIB/libbssl_crypto.a $VLIB/libusockets.a $OBJ/libuwsockets.o $OBJ/us_root_certs.o $VLIB/libcares.a $VLIB/libarchive.a $VLIB/libz.a \
