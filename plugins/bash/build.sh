...
for src in "$COMPAT/compat.c" "$TTY/termios.c" "$TTYGEN/terminal.c" \
           "$COMPAT/wkbash.c" "$COMPAT/exit_shim.c" "$EXEC/wkexec.c" "$EXEC/chdir_shim.c" \
           "$EXECGEN/exec_host.c" "$PIPE/pipe.c"; do
...
LDFLAGS="--target=wasm32-wasip2 $COMPAT/compat.o $COMPAT/termios.o $COMPAT/terminal.o \
    $COMPAT/wkbash.o $COMPAT/exit_shim.o $COMPAT/wkexec.o $COMPAT/chdir_shim.o $COMPAT/exec_host.o $COMPAT/pipe.o \
