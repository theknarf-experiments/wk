...
use bindings::wasi::webgpu::webgpu::{
    get_gpu, GpuBufferDescriptor, GpuColor, GpuExtent3D, GpuLoadOp, GpuRenderPassColorAttachment,
    GpuRenderPassDescriptor, GpuStoreOp, GpuTexelCopyBufferInfo, GpuTexelCopyTextureInfo,
    GpuTextureDescriptor, GpuTextureFormat,
};
use bindings::Guest;
